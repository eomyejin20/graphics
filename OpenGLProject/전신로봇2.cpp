...
{
	glPushMatrix();
	gluSphere(rknee, KNEE_RADIUS, 20, 10);
	glPopMatrix();
}
...
void myinit()
{
	...
	///////////////////////////////
	lelb = gluNewQuadric();
	gluQuadricDrawStyle(lelb, GLU_LINE);
	lla = gluNewQuadric();
	...
	rknee = gluNewQuadric();
	gluQuadricDrawStyle(rknee, GLU_LINE);
	lknee = gluNewQuadric();
	gluQuadricDrawStyle(lknee, GLU_LINE);
	relb = gluNewQuadric();
	gluQuadricDrawStyle(relb, GLU_LINE);
	nk = gluNewQuadric();
	gluQuadricDrawStyle(nk, GLU_LINE);
	rhand = gluNewQuadric();
	gluQuadricDrawStyle(rhand, GLU_LINE);
	lhand = gluNewQuadric();
	gluQuadricDrawStyle(lhand, GLU_LINE);
	lfoot = gluNewQuadric();
	gluQuadricDrawStyle(lfoot, GLU_LINE);
	rfoot = gluNewQuadric();
	gluQuadricDrawStyle(rfoot, GLU_LINE);
	rsh = gluNewQuadric();
	gluQuadricDrawStyle(rsh, GLU_LINE);
	lsh = gluNewQuadric();
	gluQuadricDrawStyle(lsh, GLU_LINE);
...
int main(int argc, char **argv)
{
	...
	glutCreateMenu(menu);
	glutAddMenuEntry(" Raise Right Hand ", 0);
	glutAddMenuEntry(" Raise Left Hand ", 1);
	glutAddMenuEntry(" Reset ", 2);
	glutAddMenuEntry(" Raise Right Leg ", 3);
	glutAddMenuEntry(" Raise Left Leg ", 4);
	glutAddMenuEntry(" Move Head ", 5);
